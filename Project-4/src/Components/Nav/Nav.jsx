      ...
      <div id="Nav">
         {
            visible ?
               <div className="hamburger">
                  <Link className="link" to='/Login'><div className="ham1">Login</div></Link>
                  <Link className="link" to='/Signup'><div className="ham1">SignUp</div></Link>
                  <Link className="link" to='/Listing'><div className="ham1">List your home</div></Link>
                  <Link className="link" to='/Contact'><div className="ham1">help center</div></Link>
         ...
         <div className="nav1">
            ...
            <div className="ham">
               <Link className="link" to='/Listing'><button id="btn1" >List Your Home</button></Link>
